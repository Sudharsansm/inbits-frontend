...
export const Route = createFileRoute("/menu/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Your InBits profile, saved stories, settings, and account.",
      },
    ],
  }),
  component: Menu,
    ...
    <AppShell title="Menu">
      <section className="px-4 pt-2">
        <div className="flex items-center gap-3 rounded-2xl bg-card p-4">
          <div className="grid h-14 w-14 place-items-center rounded-full bg-primary text-xl font-bold text-primary-foreground">
            M
          </div>
        ...
        <Link
          to="/menu/login"
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl border border-border bg-card py-3 text-sm font-semibold text-primary"
        >
